...
values, data, amount = lv.load_data_n_values('../c64k', value_size = 6, data_size = 220*60)

print "One-hotting values ..."
values = np.reshape(values, (amount*6))
values2 = np.zeros((amount*6, 10))
values2[np.arange(amount*6), values.astype(int)] = 1.0
